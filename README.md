...
| 도시 목록 | 날씨 상세 | 시간별 예보 |
|---|---|---|
| ![도시 목록](screenshot/screenshot1.png) | ![날씨 상세](screenshot/screenshot2.png) | ![시간별 예보](screenshot/screenshot3.png) |
| 국내 31개 도시 리스트 | 온도 / 날씨 상태 / 8가지 상세 지표 | 3시간 간격 예보 (24시간) |
| 도시 탭 → 상세 페이지로 전환 | 온도에 따라 배경색 변경 (Bento UI) | Phosphor 아이콘 적용 |
